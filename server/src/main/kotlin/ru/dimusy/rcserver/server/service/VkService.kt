...
class VkService (@Qualifier(VK_WEB_CLIENT) private val vkWebClient: WebClient) {
    fun getAll(): Mono<Any> {
        return vkWebClient.get().uri("photos.get?v=5.52&owner_id=-107400019&album_id=wall&count=1000&access_token=ab779434ab779434ab779434a3ab072bacaab77ab779434f5f0a74efc39a1d44e954bef")
