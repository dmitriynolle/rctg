...
//                .retrieve().bodyToMono(Any::class.java)
        return vkWebClient.get().uri("wall.get?v=5.84&owner_id=-107400019&offset=0&count=51&filter=owner&access_token=ab779434ab779434ab779434a3ab072bacaab77ab779434f5f0a74efc39a1d44e954bef")
                .retrieve().bodyToMono(Any::class.java)
    }
}